...
<div class="row">
    <div class="col-xs-12">
        <p class="payment_module"><a href="{$link->getModuleLink('mymodpayment','payment')|escape:'html'}" class="mymodpayment">
                {l s='Pay with simple MyMod payment module' mod='mymodpayment'} <span>(order processing will be longer)</span>
            </a>
        </p>
    </div>
</div>
        ...
        <div class="col-xs-12">
            <p class="payment_module">
                <a href="#" id="mymodpayment-api-link" class="mymodpayment">
                    {l s='Pay with MyMod Payment API' mod='mymodpayment'}</a>
            </p>
        </div>
    </div>
